...
function PatternHeader({ children, className = '' }) {
  const pattern =
    "data:image/svg+xml,%3Csvg width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M12 0L14 6L12 12L10 6L12 0zM0 12L6 14L12 12L6 10L0 12zM12 24L10 18L12 12L14 18L12 24zM24 12L18 10L12 12L18 14L24 12z' fill='%23e5e7eb' fill-opacity='0.5'/%3E%3C/svg%3E"
  return (
    <div
...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900/80 flex items-center justify-center p-4 font-inter">
      <div className="relative w-full max-w-md bg-white rounded-lg shadow-2xl border border-gray-200 overflow-hidden">
        ...
        {step === 'form' && mode === 'login' && (
          <>
            <PatternHeader className="pt-8 pb-6 px-6 text-center">
              <h1 className="text-2xl font-bold text-black uppercase tracking-wide">LOG IN</h1>
            </PatternHeader>
        ...
        {step === 'form' && mode === 'register' && (
          <>
            <PatternHeader className="pt-8 pb-6 px-6 text-center">
              <h1 className="text-2xl font-bold text-black uppercase tracking-wide">SIGN UP</h1>
            </PatternHeader>
            <form onSubmit={handleSendOtp} className="px-6 pb-8 space-y-4">
              <input
                type="text"
              ...
              />
              <div>
                <label className="sr-only" htmlFor="auth-page-referral">
                  Referral code (optional)
                </label>
                <input
                  id="auth-page-referral"
                  type="text"
                  value={referralCode}
                  onChange={(e) =>
                ...
                <p className="text-gray-500 text-xs mt-1">
                  4–16 characters. Leave blank if you don&apos;t have a code.
                </p>
        ...
        {step === 'otp' && (
          <>
            <PatternHeader className="pt-8 pb-4 px-6 text-center">
              <h1 className="text-2xl font-bold text-black uppercase tracking-wide">VERIFY OTP</h1>
            </PatternHeader>
