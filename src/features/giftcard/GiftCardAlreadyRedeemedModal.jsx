...
function RedeemedInfoIcon({ className = 'h-14 w-14 sm:h-16 sm:w-16' }) {
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
      <circle cx="32" cy="32" r="22" fill="none" stroke="#000" strokeWidth="2.5" />
      <path
        d="M32 20.5c-1.4 0-2.5 1.1-2.5 2.5s1.1 2.5 2.5 2.5 2.5-1.1 2.5-2.5-1.1-2.5-2.5-2.5z"
        fill="#000"
      />
      <path
        d="M32 29v16"
...
export default function GiftCardAlreadyRedeemedModal({
  open,
  onClose,
  ...
  return createPortal(
    ...
    >
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="giftcard-redeemed-title"
      >
        <button
          type="button"
          onClick={onClose}
