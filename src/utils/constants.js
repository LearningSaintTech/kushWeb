export const ROUTES = {
  ...
  ADDRESS: '/address',
  COMMUNITY: '/community',
  /** Auth + role gateway — redirects to feed or profile dashboard */
  COMMUNITY_ENTER: '/community/enter',
  COMMUNITY_FEED: '/community/feed',
  COMMUNITY_SEARCH: '/community/feed/search',
  COMMUNITY_REELS: '/community/feed/reels',
  COMMUNITY_PROFILE: '/community/feed/profile',
  COMMUNITY_CREATE_JOIN: '/community/feed/create',
  COMMUNITY_SAVED: '/community/feed/saved',
